...
The core functionality of Kaya comes from retrieval: looking up old bookmarks, blurbs, and files. Arbitrary files can be added, but images and PDFs are the most likely formats.
